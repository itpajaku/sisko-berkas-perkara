...
<div class="container-lg">
  <?= App\Libraries\Templ::component("layouts/page_header", [
    "page_name" => "Laporan Berkas Permohonan",
    "breadcrumbs" => [
      ["name" => "Berkas Permohonan", "url" => "/berkas_permohonan"],
      ["name" => "Laporan Berkas Permohonan", "url" => "/berkas_permohonan/laporan"]
    ]
  ]) ?>
  <div class="card border shadow">
    ...
    <div class="card-body">
      <form
        action="<?= base_url("/berkas_permohonan/laporan") ?>"
        method="post"
        target="_blank">
        <div class="row g-3 d-flex">
          ...
          <div class="col-md-3">
            ...
            <select class="form-select" id="berdasarkan" name="berdasarkan">
              ...
              <option value="<?= $this->encryption->encrypt("tanggal_putusan") ?>">Tanggal puutus</option>
            </select>
          </div>
          <div class="col-md-3">
