<div class="btn-group">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <li><a
        class="dropdown-item"
        href="<?= base_url("berkas_gugatan/ekspedisi/" . $this->hash->encode($berkas->id)) ?>">Ekspedisi</a></li>
    ...
    <?php } ?>
    <li><a class="dropdown-item" href="<?= base_url("berkas_gugatan/" . $this->hash->encode($berkas->id)) ?>">Ubah Data</a></li>
    <li>
      <a
        hx-delete="<?= base_url("berkas_gugatan/") . $this->hash->encode($berkas->id) ?>"
